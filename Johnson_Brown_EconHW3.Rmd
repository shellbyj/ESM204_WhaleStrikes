...
(-0.001*BID) = 1.20 + (.020*Ageto30) + (-.020*Ageto40) + (.010 *Ageto50) + (-.016*Ageto60) + (.003 * IncomePoor) + (.007*Rich) + (.047*IncomeVeryRich) + (.009 * IncomeOnePercent) + (0.016*** (0.002) * NEP) + (0.001 (0.001) * RiskReduction) + V(yes) = 1.20
